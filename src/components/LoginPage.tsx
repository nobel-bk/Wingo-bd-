        ...
        login(code.trim()).then((result) => {
          ...
          if (result.ok) {
            ...
            setErr(
              ...
              "❌ Invalid access code — please check and retry"
            );
          ...
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                <label style={{ fontSize: 11, fontWeight: 700, color: "var(--foreground-soft)", letterSpacing: "0.04em" }}>
                  ACCESS CODE
                </label>
              ...
              <input
                ...
                style={{ letterSpacing: "0.12em", fontSize: 15 }}
              />
            </div>
